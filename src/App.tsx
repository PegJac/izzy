      ...
      <Content>
        ...
        <Main>
          <p>
            ...
            records, instruments, and anything related to folk music. But it was
            more than a store. It was a meeting place, a classroom, a stage, and
            the home for the poets and folk musicians in the Village.
          </p>
        </Main>
        <Spacer />
        ...
        <Main>
          <p>
            Here, young and talented artists not yet with a record deal, such as
            Joni Mitchell, Emmylou Harris, Tim Buckley and Patti Smith, got a
            chance to perform, to learn, and to grow.
            <br />
            <br />
